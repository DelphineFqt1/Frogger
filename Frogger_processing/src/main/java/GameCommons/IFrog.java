...
public interface IFrog {
    abstract void deal_state_frog(Frog frog); //En 1P, détermine l'état de mort ou de victoire de la grenouille tout en agissant sur elle
    // (reset en cas d'intersection de voitures par exemple)
    ...
    abstract void deal_state_frog2P1(Frog frog); //En 2P, détermine l'état de mort ou de victoire de la grenouille gauche tout en agissant sur elle
    abstract void deal_state_frog2P2(Frog frog); //En 2P, détermine l'état de mort ou de victoire de la grenouille droite tout en agissant sur elle
