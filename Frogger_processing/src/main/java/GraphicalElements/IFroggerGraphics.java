...
public interface IFroggerGraphics {
     ...
     * @param g La valeur en nuance de vert
     * @param b La valeur en nuance de bleu
     * @throws NullPointerException si le texte à afficher est null. Peut survenir lorsque le texte à affiher provient d'un fichier illisible ou inexistant
     */
     ...
     * @throws NullPointerException si l'image est null. Peut survenir lorsque l'image est chargée à partir d'un chemin qui ne pointe pas vers pas une image, ou mal déclaré
     */
