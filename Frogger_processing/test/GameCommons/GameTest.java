...
class GameTest {
    ...
    void car_range() {
        ...
        // On verifie que la liste a la bonne taille
        ArrayList<Obstacle.Car> range = game.car_range(2);
        assertTrue(range.size() == 2 || range.size() == 3);
        // On verifie qu'en fonction de la parite la vitesse est correcte
    ...
    void allCars() {
        Game game = new Game(45,16,19);
        // On cree une liste de listes de voitures
        ArrayList<ArrayList<Obstacle.Car>> list_cars = new ArrayList<ArrayList<Obstacle.Car>>();
        // On verifie que allCars renvoie un objet du bon type
        assertEquals(game.allCars(5).getClass(), list_cars.getClass());
        // On verifie que la liste contient des voitures
    ...
    void allTrunks() {
        ...
        // On verifie que la liste contient des troncs
    ...
    void move_allCars() {
        ...
        // On verifie que toutes les voitures de la liste bougent
    ...
    void setFrog() {
        ...
        // On verifie que setFrog cree un objet de classe Frog
        assertEquals(frog.getClass(), game.setFrog(1).getClass());
        assertEquals(frog.getClass(), game.setFrog(2).getClass());
        // On verifie que l'objet cree a les bons parametres
    ...
    void reset_Frog() {
        ...
        // On verifie que frog a bien change de rangee
        frog.move(1,-1);
    ...
    void stateFrog() {
        Game game = new Game(45,16,19);
        Frog frog = new Frog(19*45 / 4, 16*45 - 45, 45);
        // On verifie que GAMEOVER est false au debut de la partie
        assertFalse(frog.isGAMEOVER());
        // On verifie que si frog atteint l'arrivee GameState est true
        frog.setRange(100);
